...
urlpatterns = [
    ...
    path('summarize/chat/', views.chat_summary, name='chat_summary'),
    path('summarize/quiz/', views.create_quiz, name='create_quiz'),
    path('summarize/quiz/save/', views.save_quiz, name='save_quiz'),
