...
def generate_document_summary(text, file_name='Document', file_mimetype='application/octet-stream'):
    ...
    try:
        ...
        prompt = (
            ...
            "2. Use HTML tags (<b>, <ul>, <li>) ONLY.\n"
            "3. ZERO space between a header and its output content.\n"
            "4. ONE empty line between a section's end and the next header.\n"
            "5. Executive Highlights MUST be a bulleted list.\n"
            f"TEXT CONTENT:\n{text[:12000]}"
        )
...
def generate_batch_synthesis(doc_ids, user):
    ...
    try:
        ...
        prompt = (
            ...
            "3. ZERO space between headers and their content.\n"
